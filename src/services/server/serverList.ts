...
async function buildServerInfo(
  entry: string,
  metadata: { customName?: string; createdAt: string; lastModified?: string; description?: string; sourceZipFile?: string; startFile?: string; projectPath?: string; javaVersion?: string } | null
): Promise<ServerInfo> {
  if (!metadata) {
    return {
      name: entry,
